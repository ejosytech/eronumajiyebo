...
class BigInteger implements \Serializable
{
    ...
    public function __construct($x = 0, $base = 10)
    {
        ...
        if ($x instanceof self::$mainEngine) {
            $this->value = clone $x;
        } elseif ($x instanceof \WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\Engine) {
     ...
     * @return BigInteger
     */
    public function add(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger $y)
    {
     ...
     * @return BigInteger
     */
    public function multiply(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger $x)
    {
     ...
     * @return BigInteger[]
     */
    public function divide(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger $y)
    {
     ...
     * @return BigInteger
     */
    public function gcd(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger
     */
    public function powMod(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger $e, \WPMailSMTP\Vendor\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger
     */
    public function modPow(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger $e, \WPMailSMTP\Vendor\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return bool
     */
    public function equals(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger $x)
    {
     ...
     * @return BigInteger
     */
    public function bitwise_and(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger $x)
    {
     ...
     * @return BigInteger
     */
    public function bitwise_or(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger $x)
    {
     ...
     * @return BigInteger
     */
    public function bitwise_xor(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger $x)
    {
     ...
     */
    public static function randomRangePrime(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger $min, \WPMailSMTP\Vendor\phpseclib3\Math\BigInteger $max)
    {
        $class = self::$mainEngine;
     ...
     * @return BigInteger
     */
    public static function randomRange(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger $min, \WPMailSMTP\Vendor\phpseclib3\Math\BigInteger $max)
    {
        $class = self::$mainEngine;
     ...
     * @return BigInteger
     */
    public function pow(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger
     */
    public static function min(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger ...$nums)
    {
        $class = self::$mainEngine;
     ...
     * @return BigInteger
     */
    public static function max(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger ...$nums)
    {
        $class = self::$mainEngine;
        $nums = \array_map(function ($num) {
            return $num->value;
     ...
     * @return bool
     */
    public function between(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger $min, \WPMailSMTP\Vendor\phpseclib3\Math\BigInteger $max)
    {
     ...
     * @return int
     */
    public static function scan1divide(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger $r)
    {
        $class = self::$mainEngine;
    ...
    public function createRecurringModuloFunction()
    {
        ...
        return function (\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger $x) use($func) {
