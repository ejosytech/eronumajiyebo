...
<main class="page lanidng-page">
    <section class="portfolio-block block-intro">
        <div class="container">
         ...
         <div class="about-me">
                <p>Hello! I am <strong>Eronu Emmanuel Majiyebo</strong></p>
        </div>
    ...
    <section class="portfolio-block photography">
        <div class="container">
            <div class="row no-gutters">
                <div class="col-md-4 col-lg-4 col-sm-12 item zoom-on-hover"><a href="#"><img class="img-fluid image" src="<?php echo site_url(); ?>\wp-content\themes\eronume51\img\nature\image5.jpg" /></a></div>
                <div class="col-md-4 col-lg-4 col-sm-12 item zoom-on-hover"><a href="#"><img class="img-fluid image" src="<?php echo site_url(); ?>\wp-content\themes\eronume51\img\nature\image2.jpg" /></a></div>
                <div class="col-md-4 col-lg-4 col-sm-12 item zoom-on-hover"><a href="#"><img class="img-fluid image" src="<?php echo site_url(); ?>\wp-content\themes\eronume51\img\tech\image4.jpg" /></a></div>
            </div>
        </div>
    </section>
    ...
    <section class="portfolio-block call-to-action border-bottom">
        <div class="container">
            <div class="d-flex justify-content-center align-items-center content">
                <h3>Like what you see?</h3><button class="btn btn-outline-primary btn-lg" type="button">Contact me</button></div>
        </div>
    </section>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-12 col-lg-5">
                <div class="portfolio-laptop-mockup">
                    <div class="screen">
                        <div class="screen-content" style="background-image:url('<?php bloginfo("template_directory");?>/img/tech/image6.png');"></div>
                    </div>
